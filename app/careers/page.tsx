...
import { Store, Bike, Wallet, Users, TrendingUp, GraduationCap, MapPin, Clock, ShieldAlert, Mail, Phone, CheckCircle2 } from "lucide-react"
import { HIRING_OPEN } from "@/lib/hiring-status"

// Archived listings. Kept here (unused while HIRING_OPEN is false) so reopening
// applications is a one-line flip in lib/hiring-status.ts rather than a rewrite.
const jobs = [
  {
    slug: "store-manager",
    title: "Store Manager",
...
const description = HIRING_OPEN
  ? "Keyo Ltd is hiring: Store Manager and Sales Agent roles now open in Nairobi. Apply online today."
  : "Career opportunities at Keyo Ltd in Nairobi. No positions are open right now, but we're always happy to hear from you."
        ...
        <div className="container mx-auto px-6">
          <div className="max-w-4xl mx-auto text-center">
            <span className="inline-block bg-white/90 text-[#4A8DFB] font-semibold px-4 py-1.5 rounded-full text-sm mb-6">
              {HIRING_OPEN ? "We're Hiring" : "Careers"}
            </span>
            <h1 className="text-5xl md:text-6xl font-bold text-gray-900 mb-6">
              {HIRING_OPEN ? "Grow With Us. Build Your Future." : "No Open Positions Right Now"}
            </h1>
            <p className="text-xl text-gray-700 leading-relaxed">
              {HIRING_OPEN
                ? "Join our team and be part of a dynamic retail network delivering great products and excellent service to our customers."
                : "We're not actively hiring at the moment. Check back soon, or reach out below if you'd like to introduce yourself."}
            </p>
          </div>
        </div>
      </div>
        ...
        <div className="container mx-auto px-6">
          <div className="max-w-5xl mx-auto">
            {HIRING_OPEN ? (
              ...
              <div className="bg-[#F8FBFF] rounded-2xl p-12 text-center mb-16 max-w-2xl mx-auto">
                <p className="text-lg text-gray-700 leading-relaxed">
                  There are no open roles at Keyo Ltd right now. New opportunities are posted here as they come up
                  — feel free to check back, or send us a message if you'd like to be kept in mind.
                </p>
              </div>
            )}
            ...
            <div className="bg-gradient-to-br from-[#5A8DEE] to-[#F8FBFF] rounded-2xl p-12 text-center">
              <h2 className="text-3xl font-bold text-gray-900 mb-4">
                {HIRING_OPEN ? "Ready to Take the Next Step?" : "Want to Get in Touch?"}
              </h2>
              <p className="text-lg text-gray-700 mb-8 max-w-2xl mx-auto">
                {HIRING_OPEN
                  ? "Apply online below, or reach out directly — we'd love to hear from you."
                  : "No positions are open, but we're always happy to hear from you."}
              </p>
              {HIRING_OPEN && (
